...
* [POST /add-analyses-to-group](endpoints/app-metadata/categorization.md#adding-analyses-to-analysis-groups)
...
* [POST /categorize_analyses](endpoints/app-metadata/categorization.md#categorizing-analyses)
...
* [GET /export-app/{app-id}](endpoints/app-metadata/updated-admin.md#exporting-a-single-step-app)
...
* [GET /get-app-descrioption/{analysis-id}](endpoints/app-metadata/information.md#getting-an-app-description)
* [GET /get-only-analysis-groups/{workspace-token}](endpoints/app-metadata/listing.md#listing-analysis-groups)
...
* [POST /secured/update-app](endpoints/app-metadata/updated-admin.md#updating-or-importing-a-single-step-app)
