...
The `implementation` field is only used for the app import service, and is not
generated by the app export service.
...
or update an app will fail if either is not provided. The import services
