...
metadactyl.db.host        = hostname.iplantcollaborative.org
metadactyl.db.port        = 5432
metadactyl.db.name        = database
metadactyl.db.user        = user
metadactyl.db.password    = password
...
metadactyl.jex.base-url = http://hostname.iplantcollaborative.org:8888
...
associated with an analysis.  This information used to be included in the
results of the analysis listing service.  The response body is in the
following format:
...
```
$ curl -s http://by-tor:8888/secured/reference-genomes?user=snow-dog | python -mjson.tool
{
    "genomes": [
        {
            "created_by": "<public>",
...
' http://by-tor:8888/secured/reference-genomes?user=snow-dog | python -mjson.tool
{
    "success": true
}
```
